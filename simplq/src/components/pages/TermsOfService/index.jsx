  ...
  <>
    ...
    <div className={styles['content']}>
      ...
      <p>
        ...
        be terminated by SimplQ at any time. Upon terminating your viewing of these materials or
      ...
      <ol type="a">
        <li>
          The materials on SimplQ&apos;s website are provided on an &apos;as is&apos; basis. SimplQ
      ...
      <p>
        ...
        of the use or inability to use the materials on SimplQ&apos;s website, even if SimplQ or a
        SimplQ authorized representative has been notified orally or in writing of the possibility
      ...
      <p>
        The materials appearing on SimplQ&apos;s website could include technical, typographical, or
        photographic errors. SimplQ does not warrant that any of the materials on its website are
        accurate, complete or current. SimplQ may make changes to the materials contained on its
        website at any time without notice. However SimplQ does not make any commitment to update
        the materials.
      </p>
      <h3>5. Links</h3>
      <p>
