    ...
    <div className={styles['card']}>
      ...
      <div className={styles['card-body']}>
        <div className={styles['description-content-container']}>
          <b>
            SimplQ is a free queue management system that anyone can use to create instant online
            queues. Our queue management app is open source and aims to make crowd maangement easy
